...
class AppQuestions(models.Model):
    ...
    isopen = models.IntegerField('是否公开',blank=True, null=True)
    iscommented = models.IntegerField('是否已评论',blank=True, null=True)
    ...
    isaudit = models.IntegerField('是否审核',blank=True, null=True)
