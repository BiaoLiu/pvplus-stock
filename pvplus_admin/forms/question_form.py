...
class QuestionForm(forms.ModelForm):
    pk_user = forms.ChoiceField(choices=base_form.get_users(), label='提问用户')
    pk_respondent = forms.ChoiceField(choices=base_form.get_users(True), label='回答用户')
...
class AnswerForm(forms.ModelForm, base_form.AuthorForm):
    pk_question = forms.ChoiceField(choices=base_form.get_question(), label='提问')
